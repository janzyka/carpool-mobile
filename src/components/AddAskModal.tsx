...
export default function AddAskModal({ visible, pois, onClose, onCreated }: Props) {
  ...
  async function handleSubmit() {
    ...
    setSubmitting(true);
    try {
      await submitAsk(from.id, to.id, departure);
      reset();
      onCreated();
    } catch {
    ...
    <Modal visible={visible} animationType="slide" transparent onRequestClose={handleClose}>
      ...
      <View style={styles.sheet}>
        <View style={styles.sheetHeader}>
          ...
          <Text style={styles.sheetTitle}>{t('asks.title')}</Text>
